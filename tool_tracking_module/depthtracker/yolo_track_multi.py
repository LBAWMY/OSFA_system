...
pred_position_pub = rospy.Publisher("/pred_position", Vector3, queue_size=10)
            ...
            with torch.no_grad():
                ...
                for i, det in enumerate(pred):  # detections per image
                    ...
                    if len(object1.undistorted_center) > 0 and len(tracked_dets1) > 0:
                        pred_position_msg = Vector3(object1.undistorted_center[0, 0], object1.undistorted_center[0, 1], filter_depth / 1000)
                    else:
                        pred_position_msg = Vector3(-1, -1,filter_depth / 1000)
                    pred_position_pub.publish(pred_position_msg)
