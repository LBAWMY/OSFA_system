        ...
        try:
            with torch.no_grad():
                ...
                for i, det in enumerate(pred):  # detections per image
                    ...
                    if len(objects[main_tool_id].center) > 0 and trackers[main_tool_id].cur_bbox_flag is True:
                        if (objects[main_tool_id].center[0] > dst_window[0] and objects[main_tool_id].center[0] < dst_window[2]) and (objects[main_tool_id].center[1] > dst_window[1] and objects[main_tool_id].center[1] < dst_window[3]) and (filter_depth > dst_depth[0] and filter_depth < dst_depth[1]):
                            ...
                            x_error, y_error = RectErrorCal(objects[main_tool_id].center, bbox=dst_window)
