...
class MainWindow_ROS(QMainWindow, Ui_MainWindow):
    ...
    def index2uterus_motion(self, index, img):
        if index == 0:
            img = paste_bbox_img(img, self.uterus_panel_up_bbox, self.uterus_panel_up_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_up_bbox, self.uterus_panel_up_click_icon, alpha=0.8)
            self.UterusUp_Mode = True
        elif index == 1:
            img = paste_bbox_img(img, self.uterus_panel_down_bbox, self.uterus_panel_down_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_down_bbox, self.uterus_panel_down_click_icon, alpha=0.8)
            self.UterusDown_Mode = True
        elif index == 2:
            img = paste_bbox_img(img, self.uterus_panel_left_bbox, self.uterus_panel_left_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_left_bbox, self.uterus_panel_left_click_icon, alpha=0.8)
            self.UterusLeft_Mode = True
        elif index == 3:
            img = paste_bbox_img(img, self.uterus_panel_right_bbox, self.uterus_panel_right_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_right_bbox, self.uterus_panel_right_click_icon, alpha=0.8)
            self.UterusRight_Mode = True
        elif index == 4:
            img = paste_bbox_img(img, self.uterus_panel_insert_bbox, self.uterus_panel_insert_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_insert_bbox, self.uterus_panel_insert_click_icon, alpha=0.8)
            self.UterusInsert_Mode = True
        elif index == 5:
            img = paste_bbox_img(img, self.uterus_panel_retract_bbox, self.uterus_panel_retract_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_retract_bbox, self.uterus_panel_retract_click_icon, alpha=0.8)
            self.UterusRetract_Mode = True
        return img
    ...
    def draw_img_GUI_left_side(self, ori_img, position, position_main):
        ...
        if ((position[0] < part_W * 2 and position[0] > 0 and position[1] < part_H * 2 and position[1] > 0)
            ...
            if is_pos_in_bbox(position, self.main_uterus_bbox_left_small) or is_pos_in_bbox(position_main, self.main_uterus_bbox_left_small):
                ...
                self.main_panel_count[0, 1] = self.main_panel_count[0, 2] = self.main_panel_count[0, 3] = 0
                if self.main_panel_count[0, 0] > count_threshold:
                    img = paste_bbox_img(img, self.main_uterus_bbox_left_large, self.uterus_panel_large_left_bg, alpha=0.6)
                    img = paste_bbox_img(img, self.main_uterus_bbox_left_large, self.uterus_panel_click_icon_large_left, alpha=0.8)
                    self.mode = 'Uterus'
                else:
                    img = paste_bbox_img(img, self.main_uterus_bbox_left_large, self.main_icon_large_left_bg, alpha=0.8)
                    img = paste_bbox_img(img, self.main_uterus_bbox_left_large, self.main_uterus_left_icon_large, alpha=0.9)

            else:
                img = paste_bbox_img(img, self.main_uterus_bbox_left_small, self.main_icon_small_bg, alpha=0.8)
                img = paste_bbox_img(img, self.main_uterus_bbox_left_small, self.main_uterus_icon_small, alpha=0.9)
        ...
        if self.mode == 'Uterus':
            ...
            img = paste_bbox_img(img, self.uterus_panel_up_bbox, self.uterus_panel_up_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_up_bbox, self.uterus_panel_up_icon, alpha=0.8)
            img = paste_bbox_img(img, self.uterus_panel_down_bbox, self.uterus_panel_down_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_down_bbox, self.uterus_panel_down_icon, alpha=0.8)
            img = paste_bbox_img(img, self.uterus_panel_left_bbox, self.uterus_panel_left_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_left_bbox, self.uterus_panel_left_icon, alpha=0.8)
            img = paste_bbox_img(img, self.uterus_panel_right_bbox, self.uterus_panel_right_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_right_bbox, self.uterus_panel_right_icon, alpha=0.8)
            img = paste_bbox_img(img, self.uterus_panel_insert_bbox, self.uterus_panel_insert_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_insert_bbox, self.uterus_panel_insert_icon, alpha=0.8)
            img = paste_bbox_img(img, self.uterus_panel_retract_bbox, self.uterus_panel_retract_bg, alpha=0.6)
            img = paste_bbox_img(img, self.uterus_panel_retract_bbox, self.uterus_panel_retract_icon, alpha=0.8)
    ...
    def draw_img_GUI_right_side(self, ori_img, position, position_main):
        ...
        if ((position[0] > resize_W - part_W * 2 and position[0] > 0 and position[1] < part_H * 2 and position[1] > 0)
            ...
            if is_pos_in_bbox(position, self.main_uterus_bbox_right_small) or is_pos_in_bbox(position_main, self.main_uterus_bbox_right_small):
                ...
                self.main_panel_count[0, 1] = self.main_panel_count[0, 2] = self.main_panel_count[0, 3] = 0
                if self.main_panel_count[0, 0] > count_threshold:
                    img = paste_bbox_img(img, self.main_uterus_bbox_right_large, self.uterus_panel_large_right_bg, alpha=0.6)
                    img = paste_bbox_img(img, self.main_uterus_bbox_right_large, self.uterus_panel_click_icon_large_right, alpha=0.8)
                    self.mode = 'Uterus'
                else:
                    img = paste_bbox_img(img, self.main_uterus_bbox_right_large, self.main_icon_large_right_bg, alpha=0.8)
                    img = paste_bbox_img(img, self.main_uterus_bbox_right_large, self.main_uterus_right_icon_large, alpha=0.9)

            else:
                img = paste_bbox_img(img, self.main_uterus_bbox_right_small, self.main_icon_small_bg, alpha=0.8)
                img = paste_bbox_img(img, self.main_uterus_bbox_right_small, self.main_uterus_icon_small, alpha=0.9)
                # img = merge_bbox_img(roi_bbox=self.main_dominant_bbox_right_small, template=self.main_domain_icon_small, img=img, alpha=0.3, beta=0.7)
                # img = merge_bbox_img(roi_bbox=self.main_switch_bbox_right_small, template=self.main_switch_icon_small, img=img, alpha=0.3, beta=0.7)
                # img = merge_bbox_img(roi_bbox=self.main_camera_bbox_right_small, template=self.main_camera_icon_small, img=img, alpha=0.3, beta=0.7)
                self.main_panel_count = np.zeros((1,4))
    ...
    def load_icons(self):
        ...
        self.main_icon_small_bg = cv2.resize(main_icon_small_bg, (part_W_l, part_H * 2))
        self.main_icon_large_left_bg = cv2.resize(main_icon_large_left_bg, (part_W * 2, part_H * 2))
        self.main_icon_large_right_bg = cv2.resize(main_icon_large_right_bg, (part_W * 2, part_H * 2))
        ...
        self.main_uterus_icon_small = cv2.resize(main_uterus_icon_small, (part_W_l, part_H * 2))
        self.main_uterus_left_icon_large = cv2.resize(main_uterus_left_icon_large, (part_W * 2, part_H * 2))
        self.main_uterus_right_icon_large = cv2.resize(main_uterus_right_icon_large, (part_W * 2, part_H * 2))
        ...
        self.main_domain_icon_small = cv2.resize(main_domain_icon_small, (part_W_l, part_H * 2))
        self.main_domain_left_icon_large = cv2.resize(main_domain_left_icon_large, (part_W * 2, part_H * 2))
        self.main_domain_right_icon_large = cv2.resize(main_domain_right_icon_large, (part_W * 2, part_H * 2))
        ...
        self.main_camera_icon_small = cv2.resize(main_camera_icon_small, (part_W_l, part_H * 2))
        self.main_camera_left_icon_large = cv2.resize(main_camera_left_icon_large, (part_W * 2, part_H * 2))
        self.main_camera_right_icon_large = cv2.resize(main_camera_right_icon_large, (part_W * 2, part_H * 2))
        ...
        self.camera_panel_large_left_bg = cv2.resize(camera_panel_large_left_bg, (part_W * 2, part_H * 2))
        self.camera_panel_large_right_bg = cv2.resize(camera_panel_large_right_bg, (part_W * 2, part_H * 2))
        self.camera_panel_small_left_bg = cv2.resize(camera_panel_small_left_bg, (camera_panel_W, camera_panel_H))
        self.camera_panel_small_right_bg = cv2.resize(camera_panel_small_right_bg, (camera_panel_W, camera_panel_H))
        self.camera_panel_small_zero_left_bg = cv2.resize(camera_panel_small_zero_left_bg,
                                                     (camera_panel_W, camera_panel_H + 2))
        self.camera_panel_small_zero_right_bg = cv2.resize(camera_panel_small_zero_right_bg,
                                                      (camera_panel_W, camera_panel_H + 2))

        # ------------ camera left -----------
        camera_panel_click_icon_large_left = cv2.imread('E:/gui_test/camera/camera_3_left.png', cv2.IMREAD_UNCHANGED)
        self.camera_panel_click_icon_large_left = cv2.resize(camera_panel_click_icon_large_left, (part_W * 2, part_H * 2))
        ...
        self.camera_panel_zoomin_icon_left = cv2.resize(camera_panel_zoomin_icon_left, (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomout_icon_left = cv2.resize(camera_panel_zoomout_icon_left, (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomauto_icon_left = cv2.resize(camera_panel_zoomauto_icon_left, (camera_panel_W, camera_panel_H))
        self.camera_panel_setzero_icon_left = cv2.resize(camera_panel_setzero_icon_left,
                                                    (camera_panel_W, camera_panel_H + 2))
        ...
        camera_panel_zoomauto_click_icon_left = cv2.imread('E:/gui_test/camera/track_click_left.png',
                                                           cv2.IMREAD_UNCHANGED)
        camera_panel_setzero_click_icon_left = cv2.imread('E:/gui_test/camera/zero_click_left.png',
                                                          cv2.IMREAD_UNCHANGED)
        self.camera_panel_zoomin_click_icon_left = cv2.resize(camera_panel_zoomin_click_icon_left,
                                                         (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomout_click_icon_left = cv2.resize(camera_panel_zoomout_click_icon_left,
                                                          (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomauto_click_icon_left = cv2.resize(camera_panel_zoomauto_click_icon_left,
                                                           (camera_panel_W, camera_panel_H))
        self.camera_panel_setzero_click_icon_left = cv2.resize(camera_panel_setzero_click_icon_left,
                                                          (camera_panel_W, camera_panel_H + 2))

        # ------------ camera right -----------
        camera_panel_click_icon_large_right = cv2.imread('E:/gui_test/camera/camera_3_right.png', cv2.IMREAD_UNCHANGED)
        self.camera_panel_click_icon_large_right = cv2.resize(camera_panel_click_icon_large_right, (part_W * 2, part_H * 2))
        ...
        self.camera_panel_zoomin_icon_right = cv2.resize(camera_panel_zoomin_icon_right, (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomout_icon_right = cv2.resize(camera_panel_zoomout_icon_right, (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomauto_icon_right = cv2.resize(camera_panel_zoomauto_icon_right,
                                                      (camera_panel_W, camera_panel_H))
        self.camera_panel_setzero_icon_right = cv2.resize(camera_panel_setzero_icon_right,
                                                     (camera_panel_W, camera_panel_H + 2))

        camera_panel_zoomin_click_icon_right = cv2.imread('E:/gui_test/camera/in_click_right.png', cv2.IMREAD_UNCHANGED)
        camera_panel_zoomout_click_icon_right = cv2.imread('E:/gui_test/camera/out_click_right.png',
                                                           cv2.IMREAD_UNCHANGED)
        camera_panel_zoomauto_click_icon_right = cv2.imread('E:/gui_test/camera/track_click_right.png',
                                                            cv2.IMREAD_UNCHANGED)
        camera_panel_setzero_click_icon_right = cv2.imread('E:/gui_test/camera/zero_click_right.png',
                                                           cv2.IMREAD_UNCHANGED)
        self.camera_panel_zoomin_click_icon_right = cv2.resize(camera_panel_zoomin_click_icon_right,
                                                          (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomout_click_icon_right = cv2.resize(camera_panel_zoomout_click_icon_right,
                                                           (camera_panel_W, camera_panel_H))
        self.camera_panel_zoomauto_click_icon_right = cv2.resize(camera_panel_zoomauto_click_icon_right,
                                                            (camera_panel_W, camera_panel_H))
        self.camera_panel_setzero_click_icon_right = cv2.resize(camera_panel_setzero_click_icon_right,
                                                           (camera_panel_W, camera_panel_H + 2))
        ...
        self.uterus_panel_large_left_bg = cv2.resize(uterus_panel_large_left_bg, (part_W * 2, part_H * 2))
        self.uterus_panel_large_right_bg = cv2.resize(uterus_panel_large_right_bg, (part_W * 2, part_H * 2))
        self.uterus_panel_up_bg = cv2.resize(uterus_panel_up_bg, (uterus_panel_W * 4, uterus_panel_H))
        self.uterus_panel_down_bg = cv2.resize(uterus_panel_down_bg, (uterus_panel_W * 4, uterus_panel_H))
        self.uterus_panel_left_bg = cv2.resize(uterus_panel_left_bg, (part_W * 2, part_H * 2))
        self.uterus_panel_right_bg = cv2.resize(uterus_panel_right_bg, (part_W * 2, part_H * 2))
        self.uterus_panel_insert_bg = cv2.resize(uterus_panel_insert_bg, (part_W * 2, part_H * 2))
        self.uterus_panel_retract_bg = cv2.resize(uterus_panel_retract_bg, (part_W * 2, part_H * 2))

        uterus_panel_click_icon_large_left = cv2.imread('E:/gui_test/uterus/uterus_3_left.png', cv2.IMREAD_UNCHANGED)
        self.uterus_panel_click_icon_large_left = cv2.resize(uterus_panel_click_icon_large_left, (part_W * 2, part_H * 2))
        uterus_panel_click_icon_large_right = cv2.imread('E:/gui_test/uterus/uterus_3_right.png', cv2.IMREAD_UNCHANGED)
        self.uterus_panel_click_icon_large_right = cv2.resize(uterus_panel_click_icon_large_right, (part_W * 2, part_H * 2))
        ...
        self.uterus_panel_down_click_icon = cv2.resize(uterus_panel_down_click_icon, (uterus_panel_W * 4, uterus_panel_H))
        self.uterus_panel_up_click_icon = cv2.resize(uterus_panel_up_click_icon, (uterus_panel_W * 4, uterus_panel_H))
        self.uterus_panel_left_click_icon = cv2.resize(uterus_panel_left_click_icon,
                                                  (uterus_panel_W * 2, uterus_panel_H * 2))
        self.uterus_panel_right_click_icon = cv2.resize(uterus_panel_right_click_icon,
                                                   (uterus_panel_W * 2, uterus_panel_H * 2))
        self.uterus_panel_insert_click_icon = cv2.resize(uterus_panel_insert_click_icon,
                                                    (uterus_panel_W * 2, uterus_panel_H * 2))
        self.uterus_panel_retract_click_icon = cv2.resize(uterus_panel_retract_click_icon,
                                                     (uterus_panel_W * 2, uterus_panel_H * 2))
        ...
        self.camera_panel_setzero_bbox_left = [0, 3*camera_panel_H, camera_panel_W, 4*camera_panel_H+2] # x1, y1, x2, y2
        #
        ...
        self.camera_panel_setzero_bbox_right = [resize_W - camera_panel_W, 3*camera_panel_H, resize_W, 4*camera_panel_H+2] # x1, y1, x2, y2
...
def add_bbox_img(roi_bbox, template, img):
    """
    bbox: x1, y1, x2, y2
    img: original image
    """
    img[roi_bbox[1]:roi_bbox[3],roi_bbox[0]:roi_bbox[2],::-1] = cv2.add(img[roi_bbox[1]:roi_bbox[3],roi_bbox[0]:roi_bbox[2],::-1], template)
    return img
...
def paste_bbox_img(img1, iou, template, alpha):
    ...
    alpha_png = template[0:template.shape[0], 0:template.shape[1], 3] / 255.0 * alpha
    alpha_jpg = 1 - alpha_png

    # add image
    for c in range(0, 3):
        img1[iou[1]:iou[3], iou[0]:iou[2], c] = ((alpha_jpg * img1[iou[1]:iou[3], iou[0]:iou[2], c]) +
                                                 (alpha_png * template[0:template.shape[0], 0:template.shape[1], c]))
